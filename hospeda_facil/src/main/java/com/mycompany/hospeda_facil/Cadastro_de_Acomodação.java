...
public class Cadastro_de_Acomodação extends javax.swing.JFrame {
    ...
    JTextField[] textFields = {
        ...
        txtfperiodoinicio,txtfperiodofim,txtfmotivobloqueio
        };
    ...
    private void initComponents() {
        ...
        txtfperiodoinicio = new javax.swing.JTextField();
        txtfperiodofim = new javax.swing.JTextField();
        ...
        jPanel1.add(btnfinalizarcadastro, new org.netbeans.lib.awtextra.AbsoluteConstraints(493, 583, 230, 50));
        ...
        jPanel1.add(txtfnumeroacomodacao, new org.netbeans.lib.awtextra.AbsoluteConstraints(470, 176, 190, 30));

        txtfnomeacomodacao.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        txtfnomeacomodacao.setBorder(null);
        jPanel1.add(txtfnomeacomodacao, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 210, 210, 30));

        txtfdescricao.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        txtfdescricao.setBorder(null);
        jPanel1.add(txtfdescricao, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 270, 640, 30));

        btnrrestricao.setBorder(null);
        jPanel1.add(btnrrestricao, new org.netbeans.lib.awtextra.AbsoluteConstraints(322, 352, -1, -1));

        txtfperiodoinicio.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        txtfperiodoinicio.setBorder(null);
        jPanel1.add(txtfperiodoinicio, new org.netbeans.lib.awtextra.AbsoluteConstraints(318, 409, 145, 30));

        txtfperiodofim.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        txtfperiodofim.setBorder(null);
        jPanel1.add(txtfperiodofim, new org.netbeans.lib.awtextra.AbsoluteConstraints(560, 409, 145, 30));

        txtfmotivobloqueio.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        txtfmotivobloqueio.setBorder(null);
        jPanel1.add(txtfmotivobloqueio, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 470, 630, 30));

        lblimagemcadastrofuncionario.setFont(new java.awt.Font("Arial", 0, 18)); // NOI18N
        lblimagemcadastrofuncionario.setIcon(new javax.swing.ImageIcon("C:\\Users\\NEY SCHUNK\\Desktop\\HOSPEDA_FACIL\\Projeto_hospeda_facil\\hospeda_facil\\src\\main\\java\\com\\mycompany\\hospeda_facil\\imagens_telas\\CadastroAcomodação.png")); // NOI18N
        jPanel1.add(lblimagemcadastrofuncionario, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1200, -1));
    ...
    private javax.swing.JTextField txtfperiodofim;
    private javax.swing.JTextField txtfperiodoinicio;
